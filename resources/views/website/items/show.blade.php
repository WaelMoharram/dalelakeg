    ...
    <section id="page-title">
        ...
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="{{route('items.index')}}">{{__('Items')}}</a></li>
            </ol>
        </div>
                        ...
                        <div class="row gutter-40">
                                    ...
                                    <div class="fslider" data-pagi="false" data-arrows="false" data-thumbs="true">
                                        <div class="flexslider">
                                            <div class="slider-wrap" data-lightbox="gallery">
                                                <div class="slide" data-thumb="{{url($item->image1)}}"><a href="{{url($item->image1)}}" title="Product name - Front View" data-lightbox="gallery-item"><img src="{{url($item->image1)}}" alt="Product name"></a></div>
                                                <div class="slide" data-thumb="{{url($item->image2)}}"><a href="{{url($item->image2)}}" title="Product name - Side View" data-lightbox="gallery-item"><img src="{{url($item->image2)}}" alt="Product name"></a></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 product-desc">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    ============================================= -->
                                    @if($item->sale_price != null && $item->sale_price != 0 &&$item->sale_price < $item->price  )
                                    <div class="product-price"><del>{{__('SAR')}} {{$item->price}}</del> <ins>{{__('SAR')}} {{$item->sale_price}}</ins></div><!-- Product Single - Price End -->
                                    @endif
...
{{--                                    <button type="submit" class="add-to-cart button m-0">{{__('Add to cart')}}</button>--}}
...
{{--                                        <span itemprop="productID" class="sku_wrapper">SKU: <span class="sku">8465415</span></span>--}}
                                        <span class="posted_in">{{__('Brand')}}: <a href="{{route('categories.show',$item->category_id)}}" rel="tag">{{optional($item->category)->name}}</a>.</span>
                                         </div>
                            ...
                            <div class="oc-item">
                                <div class="product">
                                    ...
                                    <div class="product-desc">
                                        ...
                                        @if($item->sale_price != null && $item->sale_price != 0 &&$item->sale_price < $item->price  )
                                            <div class="product-price"><del>{{$item->price}}</del> <ins>{{$item->sale_price}} {{__('SAR')}}</ins></div>
                                        @else
