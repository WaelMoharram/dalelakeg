...
<div class="form-group py-1 col-md-6">
    <label for="lang"> {{__('Blog language')}} </label>
    {{Form::select('lang',['ar'=>__('Arabic'),'en'=>__('English')] ,null,['class'=>'form-control mb-2','id'=>'lang','placeholder'=>__('Select Blog language')])}}
