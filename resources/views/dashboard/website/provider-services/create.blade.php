...
@section('title'){!! __('Create provider service') !!}@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            {!! Form::open(['method'=>'post','route'=>'dashboard.provider-services.store','class'=>'form','enctype' => 'multipart/form-data']) !!}
                            @csrf()
                            <div class="row">
