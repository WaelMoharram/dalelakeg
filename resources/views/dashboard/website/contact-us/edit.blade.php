...
@section('title'){!! __('Edit Contact us page') !!}@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            @csrf()
                            <div class="row">
                                @include('dashboard.website.contact-us.partials._form')
...
@section('js-validation')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Website\ContactUsRequest', '.form'); !!}
@endsection
