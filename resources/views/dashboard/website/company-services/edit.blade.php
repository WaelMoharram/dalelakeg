...
@section('title'){!! __('Edit company service') !!}@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            {!! Form::model($service,['method'=>'put','route'=>['dashboard.company-services.update',$service->id],'class'=>'form','enctype' => 'multipart/form-data']  ) !!}
                            @csrf()
                            <div class="row">
