...
<nav class="primary-menu with-arrows">
    ...
    <ul class="menu-container">
        @if(app()->getLocale() == 'en')
            {{app()->getLocale()}}
        <li class="menu-item @if(Request::is('/')) current  @endif"><a class="menu-link" href="{{route('home')}}"><div>{{__('Homee')}}</div></a></li>
        ...
        <li class="menu-item mega-menu"><div class="menu-link"><div>{{__('Services')}}</div></div>
            <div class="mega-menu-content mega-menu-style-2 px-0">
                <div class="container">
                    <div class="row">
                        @foreach(\App\Models\Service::where('type','service')->get()->take(6) as $service)
