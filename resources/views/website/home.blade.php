                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="feature-box flex-md-row-reverse text-md-end border-0">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{asset('assets/website')}}/demos/seo/images/icons/seo.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                        ...
                        <div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{asset('assets/website')}}/demos/seo/images/icons/adword.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                        ...
                        <div class="feature-box flex-md-row-reverse text-md-end border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{asset('assets/website')}}/demos/seo/images/icons/analysis.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="feature-box border-0">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{asset('assets/website')}}/demos/seo/images/icons/social.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                        ...
                        <div class="feature-box border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{asset('assets/website')}}/demos/seo/images/icons/experience.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
                        ...
                        <div class="feature-box border-0 mt-5">
                            <div class="fbox-icon">
                                <a href="#"><img src="{{asset('assets/website')}}/demos/seo/images/icons/content_marketing.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                            </div>
                            <div class="fbox-content">
